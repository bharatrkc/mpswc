...
/* themes/mpinvestnew/templates/status-messages.html.twig */
class __TwigTemplate_3f3d784c7a3c3f8626e5b8be9a004ff0a3db308114a943da1274008f5ac142d7 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["type"] => $context["messages"]) {
            ...
            echo " class=\"messages messages--status\">
    ";
            // line 28
...
";
    ...
    {
        return "themes/mpinvestnew/templates/status-messages.html.twig";
    }
...
{% for type, messages in message_list %}
  <div role=\"contentinfo\" aria-label=\"{{ status_headings[type] }}\"{{ attributes|without('role', 'aria-label') }} class=\"messages messages--status\">
    {% if type == 'error' %}
      <div role=\"alert\">
    {% endif %}
