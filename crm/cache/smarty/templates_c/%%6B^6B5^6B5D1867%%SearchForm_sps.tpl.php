<?php /* Smarty version 2.6.29, created on 2017-08-29 11:59:13
         compiled from cache/themes/SuiteP/modules/Meetings/SearchForm_sps.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Meetings/SearchForm_sps.tpl', 31, false),array('function', 'math', 'cache/themes/SuiteP/modules/Meetings/SearchForm_sps.tpl', 32, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Meetings/SearchForm_sps.tpl', 41, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Meetings/SearchForm_sps.tpl', 47, false),array('function', 'sugar_getimage', 'cache/themes/SuiteP/modules/Meetings/SearchForm_sps.tpl', 141, false),array('modifier', 'default', 'cache/themes/SuiteP/modules/Meetings/SearchForm_sps.tpl', 149, false),array('modifier', 'count', 'cache/themes/SuiteP/modules/Meetings/SearchForm_sps.tpl', 280, false),)), $this); ?>
...
</table><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_name_sps\']={"form":"search_form","method":"query","modules":[null],"group":"or","field_list":["name","id"],"populate_list":["name_sps","_sps"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_modified_by_name_sps\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_sps","modified_user_id_sps"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_sps\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_sps","created_by_sps"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_sps\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_sps","assigned_user_id_sps"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_contact_name_sps\']={"form":"search_form","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["contact_name_sps","contact_id_sps","contact_id_sps","contact_id_sps"],"required_list":["contact_id"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_parent_name_sps\']={"form":"search_form","method":"query","modules":[null],"group":"or","field_list":["name","id"],"populate_list":["parent_name_sps","parent_id_sps"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_jjwg_maps_address_c_sps\']={"form":"search_form","method":"query","modules":[null],"group":"or","field_list":["name","id"],"populate_list":["jjwg_maps_address_c_sps","_sps"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_jjwg_maps_geocode_status_c_sps\']={"form":"search_form","method":"query","modules":[null],"group":"or","field_list":["name","id"],"populate_list":["jjwg_maps_geocode_status_c_sps","_sps"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_jjwg_maps_lat_c_sps\']={"form":"search_form","method":"query","modules":[null],"group":"or","field_list":["name","id"],"populate_list":["jjwg_maps_lat_c_sps","_sps"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_jjwg_maps_lng_c_sps\']={"form":"search_form","method":"query","modules":[null],"group":"or","field_list":["name","id"],"populate_list":["jjwg_maps_lng_c_sps","_sps"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>