...
/**
 * This is the model class for table "{{%service_consent_to_operate}}".
 *
 * @property integer $id
 ...
 */
class ServiceConsentToOperate extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%service_consent_to_operate}}';
    }
