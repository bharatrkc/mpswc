...
/**
 * This is the model class for table "{{%service_authorization_under_hazardous_waste_rules}}".
 *
 * @property integer $id
 ...
 */
class ServiceAuthorizationUnderHazardousWasteRules extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%service_authorization_under_hazardous_waste_rules}}';
    }
