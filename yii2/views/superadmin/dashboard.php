                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content no-padding">
                        <div class="flot-chart m-t-lg" style="height: 55px;">
                            <div class="flot-chart-content" id="flot-chart1" style="padding: 0px; position: relative;"><canvas class="flot-base" width="340" height="55" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 340px; height: 55px;"></canvas><canvas class="flot-overlay" width="340" height="55" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 340px; height: 55px;"></canvas></div>
                        </div>
                    </div>
