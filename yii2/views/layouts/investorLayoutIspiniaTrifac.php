...
<head>
    ...
    <link href="inspinia/css/plugins/dataTables/dataTables.bootstrap.css" rel="stylesheet">
    <link href="inspinia/css/plugins/dataTables/dataTables.responsive.css" rel="stylesheet">
    <link href="inspinia/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="active">
                   <a href="<?= Url::to(['trifac/index']) ?>"><i class="fa fa-th-large"></i> <span class="nav-label">Dashboards</span></a> 
                </li> 
                <li>
                    <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Reports</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="index.php?r=trifac/index">MD Dashboard</a></li>  
                    </ul>
                </li>                
            </ul>
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-alerts">
						...
						$model= Notifications::find()->limit('5')->orderBy(['date_created' => SORT_DESC])->all();
						...
						<li>
                            <a href="#">
                                <div>
                                    <i class="fa fa-envelope fa-fw"></i> <?php echo $val['notification_detail']; ?>
                                    <span class="pull-right text-muted small"> <?php echo date('d M Y',strtotime($val['date_created'])); ?> </span>
                                </div>
                            </a>
                        </li>
	...
	<script>
        $(document).ready(function() {
            $('.dataTables-example').dataTable({
                ...
                "dom": 'T<"clear">lfrtip',
                "tableTools": {
                    "sSwfPath": "inspinia/js/plugins/dataTables/swf/copy_csv_xls_pdf.swf"
                }
            });
