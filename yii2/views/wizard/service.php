...
<style>
                    .online-ouery .control-label{
                        text-align: left;
                        font-weight: 500;
                    }
                    .online-ouery .form-control {
                        border-radius: 0;
                        border: 1px solid #c1c1c1;
                        background: #fff;  
                        box-shadow: none;
                    }
                    .online-ouery .form-group {
                        margin-bottom: 10px;
                        /*background: rgba(95, 158, 160, 0.08);*/
                    }
                    /*.online-ouery .form-group:nth-child(2n-1) {
                        background: #f6f9ee;
                    }*/
                </style>
...
<div class="container inv_senario online-ouery p-0">
&nbsp;<br>&nbsp;<br>
	<h2 class="m-0"><?= Html::encode($this->title) ?></h2>
	<div class="h-devider"></div>


	<div class="panel panel-default pnl_jp">
...
foreach ($questiongroups as $questiongroup): ?>
			...
			<div class="panel-heading"><h3 class="panel-title"><?= $questiongroup[0]->heading ?></h3>
				<span class="pull-right panelcollaps"><i class="glyphicon glyphicon-chevron-up"></i></span>
