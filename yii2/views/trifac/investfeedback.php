...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Investor Feedback Report</h2>
                </div>
                <div class="col-lg-2">
             ...
             <div class="row">
              ...
              <div class="ibox-title" style="border: none;">
               ...
               <div class="ibox-content">
                ...
                <div> Y - Axis : Number Of feedbacks</div>
               </div>
            </div>
           </div>
        </div>
  ...
  <div class="ibox-content m-b-sm border-bottom">
                <div class="row">
                        ...
                        <div class="ibox-title" style="border-bottom:2px solid #e7eaec; border-top:none;">
                            <h5>Department List - Decending Order of Feedbacks</h5>
                        </div>
                                        ...
                                        <table class="table table-striped">
                                            <thead>
                                                ...
                                                <input type="text" id="price" name="price" value="" placeholder="Name" class="form-control">
                                                 ...
                                                 <td>
                                                  <div class="form-group">
                                                <label class="control-label" for="status">Total feedbacks</label>
