				...
				<div class="ibox-content">
						...
						<div class="col-lg-6">
							<div class="panel panel-default">
								<div class="panel-heading">
									<span class="badge" style="background-color:#23c6c8; float:right;"><h4><?php echo Projectidvs::projectidv($proid,$ucreateby); ?></h4></span>
									<h4>Project ID</h4>
								</div> 
								<ul class="list-group">          
                 <!--                           <li class="list-group-item ">
                     ...
                     -->                   
                                            ...
                                            <li class="list-group-item ">
                                                <span class="badge badge-info"><?php echo Projectidvs::investoridv($ucreateby); ?></span>
                                                User ID
                                            </li>
                                            <li class="list-group-item ">
                                                <div class="text-right">
	                                                <a href="<?= Url::to(['project/view', 'projectId' => $project->id]) ?>">
...
<div class="ibox-content m-b-sm border-bottom">
	<div class="row">
		<div class="ibox-content" style="border: none;">
			...
			foreach($investorproject_detail as $keyp=>$valp)
			{
				if($valp['completed']!=1 && $valp['type']=='pre-establishment')
				{
				$allcheck_x = 1;
				}
				if($valp['completed']!=1 && $valp['type']=='pre-operational')
				{
				$allcheck_xn = 1;
				}
			}
			...
			<?php }
				...
				else if(($project->id)!=NULL && $allcheck_x==1) {
				?>
					<div class="col-lg-5">
						<a href="<?= Url::to(['caf/cafservices', 'projectId' => $project->id ,'type'=>'prestablishment'] ) ?>">
							<button class="btn btn-success dim btn-large-dim btn-outline vwport" type="button" style="font-size: 15px;padding: 10px 15px 5px 15px;height: auto;"><i class="fa fa-chain"></i> Continue to Wizard</button></a>
					</div>
			<?php } ?>

			<div class="col-lg-5">
				<a href="<?= Url::to(['caf/services-manual', 'projectId' => $project->id, 'type' => 'prestablishment']) ?>">
...
<div class="row">
		<div class="ibox-content" style="border: none;">
			...
			else if(($project->id)!=NULL && $allcheck_xn==1) {
			?>
			<div class="col-lg-5">
						<a href="<?= Url::to(['caf/cafservices', 'projectId' => $project->id ,'type'=>'preoperational'] ) ?>">
							<button class="btn btn-success dim btn-large-dim btn-outline vwport" type="button" style="font-size: 15px;padding: 10px 15px 5px 15px;height: auto;"><i class="fa fa-chain"></i> Continue to Wizard</button></a>
					</div>
			<?php
			}
			?>
			<div class="col-lg-5">
				<a href="<?= Url::to(['caf/services-manual', 'projectId' => $project->id, 'type' => 'preoperational']) ?>">
					<button class="btn btn-warning  dim btn-large-dim btn-outline vwport" type="button"  style="font-size: 15px;padding: 10px 15px 5px 15px;height: auto;"><i class="fa fa-edit"></i> Manually through services list</button>
				</a>
			</div>
		</div>
			...
			<div class="col-lg-12">
				...
				<tr>
					...
					<td class="btn-success">
						...
						if($compstst=="yes" && $dartft=="no"){ echo "Forward"; } ?>
					</td>
				   ...
				   <td>                                
						<span class="fa fa-history sttrack"></span>
...
<div class="alertin">
	...
	<div class="col-lg-6">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Service Tracking History</h5>
                            <div class="ibox-tools">
                        ...
                        <div class="ibox-content inspinia-timeline" style="height:300px !important; overflow-y:scroll;">
									...
									<div class="timeline-item">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8 content no-top-border">
                                                <p class="m-b-xs"><strong>Under Review</strong></p>

                                                <p>Opened By department and marked as under review</p>
									...
									<div class="timeline-item">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-8 content">
                                                <p class="m-b-xs"><strong>Document Submitted</strong></p>

                                                <p>Document uploaded by Investor</p>
