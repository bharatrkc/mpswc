...
$this->title = 'Consent to Establish (under Water Act 1974 & Air Act 1981)'; 
...
<div class="container-fluid">
	...
	<div class="portlet box green">
		<div class="portlet-title">
			<div class="caption"><i class="fa fa-list"></i>Consent to Establish (under Water Act 1974 & Air Act 1981)</div>
			<div class="tools"> </div>
		</div> 
		...
		<div class="row"> 
			...
			<div class="col-lg-6">
					<?= $form->field($model, 'water_etps_cetp_member')->textInput(['maxlength' => true])->label('CETP Member'); ?>
			</div>  
		</div>  
		<div class="row"> 
			<div class="col-lg-6">  
