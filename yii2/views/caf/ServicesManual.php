...
.col{border-bottom:1px solid #ccc;padding:8px 10px;}
...
<div class="form-investor">
	<div class="portlet box green">
		<div class="portlet-title">
			<div class="caption"><i class="fa fa-list"></i>	<strong>List of Services to apply:</strong></div>
			<div class="tools"> </div>
		</div>
...
?>
	...
	<div class="row"> 
		<div class="col-xs-1 col"><strong>#</strong> </div>
		<div class="col-xs-9 col"><strong>Service Name</strong> </div> 
		<div class="col-xs-2 col"><strong><a href="javascript:void()" id="select-all">Select All</a></strong> </div> 
	</div>
	<?php
	$i = 0;
	foreach ($services_manual as $services_man):
 	//echo '<pre>'; print_r($investorproject_detail); exit;
		...
		if(!isset($investorproject_service[$service_id]['name'])) { ?>
			...
			<div class="row"> 
				<div class="col-xs-1 col"><?php print $i; ?></div> 
				<div class="col-xs-9 col"><?php echo $services_man['services']; ?></div>  
		...
		<?php 
					...
					if($investorproject_service[$service_id]['projectdetail']['status']==2) {
						$disabled = 'disabled';
						$checked = 'checked';
					}
