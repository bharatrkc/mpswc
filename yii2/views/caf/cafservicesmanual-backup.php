...
<?php
	...
	<?php 
		...
		foreach ($investorproject_detail as $key1=>$service): 
			...
			if($service['industry_status'] == 'Pre Operational') {
				   ...
				   <table class="table table-bordered table-striped table-hover">
					...
					if(isset($services_all)) {
						if(count($services_all)) {
							...
							if($service_all1['industry_status'] == 'Pre Establishment') { 
								   ...
								   <tr>
										...
										<td class=" " style="text-align:center;">
										<button class="servdetail btn btn-sm btn-info" data-valids="<?php echo $service_all1['id']; ?>">View Details</button>
										</td>
									</tr> 
							 <?php
								$i++;
...
<?php
	...
	<?php 
		...
		foreach ($services_all as $services_all1): 
			...
			if($services_all1['industry_status'] == 'Pre Operational') {
				...
				?>
			     <tr>
				  ...
				  <td class=" " style="text-align:center;">
					<button class="servdetail  btn btn-sm btn-info" data-valids="<?php echo $services_all1['id']; ?>">View Details</button>
				  </td>
				</tr>
				<?php
				$i++;
